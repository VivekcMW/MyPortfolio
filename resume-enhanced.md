...
#### **Design Systems Architecture — Multi-Domain, Multi-Scale**
[→ View detailed case study](https://uxvivek.netlify.app/work/design-systems-scale)

*Personal ownership: System architecture, domain modeling, token naming, accessibility compliance, Figma documentation, team education*

- **Strategic System Design:** Architected a 6-domain design system (OOH, Data Science, AI, FinTech, Design Engineering, Consumer) with 6 composable color palettes (Dark, Light, High Contrast, Warm, Cool, Sepia). Each domain has semantic-named tokens, design rationale, and accessibility targets (WCAG AA baseline, WCAG AAA for OOH and High Contrast).
- **Accessibility First:** Every domain's palette designed to meet or exceed WCAG accessibility standards before teams ship. OOH domain targets 13.2:1 contrast for outdoor legibility; High Contrast reaches 21:1. Zero contrast violations shipped across 7 products; accessibility audit violations dropped to 1% over 18 months.
- **Design Efficiency:** Semantic token naming (Primary/Secondary/Success/Error vs. blue-600/blue-700) reduced designer onboarding time by 40% and design review cycles by 40%. New team members understand "what is this token for?" not "what color is this?"
- **System Maturity:** Designed component library (80+ components) shared across all 7 products; component duplication dropped from 14 variants (unintentional) to 4 (intentional). Design-to-engineering handoff time reduced by 50%.
- **Team Scale:** Single system enabled 3 design teams to work independently without creating design fracture. Figma file serves as source of truth for visuals; TypeScript tokens serve as source of truth for implementation. Bidirectional sync enforced through code review.
...
**Onx Software Systems (Slate Technologies)** | 11/2021 – 03/2023

*Personal ownership: Team leadership, research strategy, design system, engineering handoff, stakeholder alignment*

- **Team Leadership:** Led team of 4 designers and front-end developers on Slate.ai, a construction-cloud SaaS for the U.S. market. Owned research, wireframing, prototyping, and design implementation; drove design critique culture reducing design revision cycles by 30%.
- **Product Outcomes:** Slate.ai achieved 92% customer satisfaction rating (NPS 58) and 85% feature adoption for core workflows (Submittals, RFIs, submittals management).
- **Cross-functional Collaboration:** Collaborated with stakeholders and engineering to gather requirements and maintain alignment to industry standards; established weekly design-engineering syncs that improved spec clarity by 25%.

---

### Team Lead — Global UI UX
**Quinnox** | 05/2020 – 10/2021

*Personal ownership: Design & research leadership, sprint planning, Agile process, global team coordination*

- **AIOps Platform:** Led design and research for AIOps automation SaaS in DevOps space; ran sprint planning, managed team, and coordinated with global teams in Agile environment.
- **Business Impact:** Platform adoption increased 55% YoY; customer satisfaction score lifted from 62 to 78 (out of 100) through iterative user research and workflow optimization.

---

### Senior UI UX Designer
**Microland Limited** | 09/2018 – 01/2020

- Designed IIoT applications for Smart Factory / Industry 4.0 programs spanning Big Data, ML, AI, and IoT platforms.
- Delivered 6 product experiences used by 50+ enterprises; reduced onboarding time by 40% through progressive disclosure and inline help patterns.

---

### UI UX Designer — Big Data & IoT
**Knowledge Lens Pvt Ltd** | 06/2016 – 11/2017

- Designed Big Data and IoT product interfaces across enterprise monitoring and analytics use cases.
- Established accessibility baseline; achieved WCAG 2.1 AA compliance across all designed surfaces.
...
- OpenRTB 2.6 & IAB Taxonomies
- Inventory & Yield Management
- Proof-of-Play & Campaign Verification
- Audience Measurement & Analytics

**Design & Systems**
- User Research & Analysis
- Usability Testing & Research Synthesis
- Information Architecture & Interaction Design
- Design Systems & Component Libraries
- Responsive & Accessible Design (WCAG 2.1 AA/AAA)
- Visual Design & Brand Systems

**AI & Emerging Tech**
- Agentic UI / Hybrid UI Strategy & Design
- AI-Powered Workflow Design
- Prompt Engineering for Design Research Synthesis
- AI Tool Integration (Claude, Figma Make, UX Pilot)

**Leadership & Operations**
- Design Team Leadership & Mentoring
- Design Critique & Process
- Stakeholder Engagement & Influence
- Design Ops & Agile/Scrum Process
...
**[ConstructivIQ: Building Design System & AI-Powered Submittals Workflow](https://uxvivek.netlify.app/work/constructiviq)**
How I scaled a ground-up Construction Cloud platform with a design system (80+ components), AI-assisted workflows (35% effort reduction), and cross-functional alignment that generated $1.2M ARR in Year 1.
...
**FlexEHR Healthcare Solutions** — SaaS electronic health record platform. Patient management, scheduling, and billing integration. [flexehr.in](https://flexehr.in)

---

## CERTIFICATION & LANGUAGES

**Certification:** Human Factor Interaction
